...
from data_engine.binance_futures.manage_data import binance_websocket, process_db_queue
...
logger = logging.getLogger("DataEngine-Futures")
...
async def main():
    logger.info("🚀 Data Engine (Binance Futures) Başlatılıyor...")
