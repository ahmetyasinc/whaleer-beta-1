    ...
    const baseClasses = isMobile 
      ...
      return (
        ...
        >
          ...
          <span
            className="
              pointer-events-none absolute inset-x-2 -bottom-px h-px origin-center
              bg-gradient-to-r from-transparent via-sky-500 to-transparent
              transition-transform duration-400 group-hover:scale-x-100 scale-x-0
            "
          />
    ...
    <>
      ...
      <header 
        className={[
          ...
          scrolled 
            ? "bg-[rgb(0,0,0,0)] backdrop-blur-lg shadow-[0_8px_32px_rgba(0,0,0,0.4)]" 
            : "bg-transparent"
        ].join(" ")}
      >
