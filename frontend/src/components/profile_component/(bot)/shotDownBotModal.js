      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            exit={{ scale: 0.95 }}
          >
            <h2 className="text-lg font-semibold mb-4">Botu sonlandırmak istediğinize emin misiniz?</h2>

            <div className="flex items-start gap-2 mb-2">
              <IoWarningOutline className="text-3xl text-orange-500 mt-0.5" />
              <p className="text-sm  text-zinc-200">
                Botunuz durdurulacak ve tüm açık işlemler kapatılacaktır. Lütfen hesap cüzdanınızı kontrol ediniz.
              </p>
            </div>
