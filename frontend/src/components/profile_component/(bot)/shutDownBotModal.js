      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            exit={{ scale: 0.95 }}
          >
            <h2 id="shutdown-modal-title" className="text-lg font-semibold mb-4">
              {t("title")}
            </h2>

            <div className="flex items-start gap-2 mb-2">
              <IoWarningOutline className="text-3xl text-orange-500 mt-0.5" />
              <p id="shutdown-modal-desc" className="text-sm text-zinc-200">
                {t("warning")}
              </p>
            </div>

            <p className="text-sm text-zinc-400 mb-3 ml-5">
              {t("irreversible")}
            </p>
