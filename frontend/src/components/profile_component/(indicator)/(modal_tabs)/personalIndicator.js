...
import useIndicatorDataStore from "@/store/indicator/indicatorDataStore"; // ✅ ekledik
...
const PersonalIndicators = () => {
  ...
  const { indicatorData } = useIndicatorDataStore(); // ✅ error bilgisi buradan
      ...
      <div className="w-full max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900">
        {indicators.length === 0 ? (
          ...
          indicators.map((indicator) => {
            // ✅ indicatorData içinden son subItem'ı bul
            const subItems = indicatorData?.[indicator.id]?.subItems;
            const lastSub =
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      openPanel(indicator.name, indicator.code, indicator);
                    }}
                  >
                ...
                {showDeleteModal && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black/10">
                    <div className="bg-gray-900 text-white rounded-md w-[400px] p-6 shadow-lg relative">
                      ...
                      <p>
                        {selectedIndicator?.name} indikatörünü silmek istediğinize emin
                        misiniz?
                      </p>
