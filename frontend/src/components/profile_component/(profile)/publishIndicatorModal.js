...
export const PublishIndicatorModal = ({ isOpen, onClose, onPublish }) => {
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative bg-zinc-950 text-zinc-100 rounded-xl border border-zinc-800 shadow-2xl w-full max-w-lg flex flex-col max-h-[85vh] overflow-hidden transition-transform duration-100 transform scale-100">
