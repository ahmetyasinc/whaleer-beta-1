...
const initialCoins = [
  ...
  { symbol: 'AVAX/USDT' }, { symbol: 'ADA/USDT' }, { symbol: 'WLD/USDT' },
  { symbol: 'PEPE/USDT' }, { symbol: 'DOGE/USDT' }, { symbol: 'SUI/USDT' },
  { symbol: 'RENDER/USDT' }, { symbol: 'APT/USDT' }, { symbol: 'FET/USDT' },
  { symbol: 'STRK/USDT' }, { symbol: 'NEIRO/USDT' }, { symbol: 'ARKM/USDT' },
  { symbol: 'PNUT/USDT' }, { symbol: 'ENA/USDT' }, { symbol: 'EIGEN/USDT' },
  { symbol: 'ARB/USDT' }, { symbol: 'LTC/USDT' },
];
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-zinc-900 w-[800px] h-[500px] rounded-lg p-4 flex gap-4 text-white relative">
          ...
          <div className="overflow-y-auto flex-1 space-y-2">
            {filteredCoins.length === 0 ? (
              <div className="text-sm text-zinc-400">
                {searchTerm ? "No results found." : "All coins have been added."}
              </div>
            ) : (
        ...
        {/* Selected Coins (Right Panel) */}
        <div className="w-1/2 pl-4 flex flex-col h-full">
          <h2 className="text-sm font-bold mb-2 sticky top-0 bg-zinc-900">Selected Coins</h2>
          <div className="flex-1 overflow-y-auto space-y-2">
            {selectedCoins.length === 0 ? (
              <div className="text-sm text-zinc-400">No coins selected yet.</div>
            ) : (
