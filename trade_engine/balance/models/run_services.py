...
try:
    from trade_engine.balance.models.balance_update_manager import (
...
try:
    from trade_engine.balance.models.spot_ws_service import main as spot_main
except ImportError:
    print("❌ spot_ws_service import hatası:")
    traceback.print_exc()
    spot_main = None
try:
    from trade_engine.balance.models.ws_service import main as futures_main
except ImportError:
